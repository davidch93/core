...
public class DateUtil {
	 ...
	 *            {@link Date} date.
	 * @param format
	 *            {@link String} date in format string ("dd-MM-yyyy" or "HH :
	 *            mm" or others).
	 * @return {@link String} date in string.
	 * @throws Exception
	 *             Parameter date can't be null or Parameter format can't be
	 *             null.
	 */
